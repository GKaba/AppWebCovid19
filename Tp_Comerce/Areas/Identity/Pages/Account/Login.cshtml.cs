...
namespace Tp_Comerce.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var userInfo = _context.ApplicationUsers.FirstOrDefault(c => c.Email.ToLower() == Input.Email.ToLower());
